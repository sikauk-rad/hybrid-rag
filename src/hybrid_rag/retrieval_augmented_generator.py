...
class RetrievalAugmentedGenerator:
    ...
    def respond_to_standalone_question(
        ...
        temperature: Number = 0,
        n_documents: int = 30,
        weighted_score_threshold: float = 0.5,
        filters: Iterable[pl.Expr] = [],
        rerank: bool = True,
        rerank_score_threshold: Number = -1,
        history_token_limit: int = 0,
        custom_history: list[OpenAIMessageCountType] | None = None,
    ) -> tuple[str, int]:
    ...
    def process_response(
        self,
        query: str,
        target_language: str = 'British English',
        temperature: Number = 0,
        history_token_limit: int = 0,
        custom_history: list[OpenAIMessageCountType] | None = None,
    ) -> tuple[str, int]:
    ...
    async def arespond_to_query(
        ...
        query: str,
        history_model_temperature: Number = 0,
        history_model_custom_history:  list[dict[Literal['role', 'content', 'tokens'], str | int]] | None = None,
        question_model_temperature: Number = 0,
        n_documents: int = 30,
        weighted_score_threshold: float = 0.5,
        filters: Iterable[pl.Expr] = [],
